...
class TaskApprovalNotificationModal extends Component
{
    ...
    public function checkForApprovedTasks()
    {
        ...
        if ($recentlyApproved && $recentlyApproved->task) {
            ...
            $this->continueUrl = route('learning');
    ...
    {
        return view('livewire.task-approval-notification-modal');
    }
}
