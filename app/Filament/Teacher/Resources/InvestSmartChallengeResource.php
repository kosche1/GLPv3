...
use App\Filament\Teacher\Resources\InvestSmartChallengeResource\Pages;
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('submissions')
                    ...
                    ->url(fn (InvestmentChallenge $record) => route('filament.teacher.resources.investment-challenge-submissions.index', ['challenge_id' => $record->id])),
            ])
            ->bulkActions([
