...
use App\Filament\Teacher\Resources\UserRecipeResource\Pages;
                    ...
                    ->action(function (UserRecipe $record) {
                        ...
                        Notification::make()
                            ...
                            ->actions([
                                Action::make('view')
                                    ->button()
                                    ->url(route('filament.teacher.resources.user-recipes.edit', $record))
                            ])
                            ->send();

                        // Show a popup notification that stays longer
                        Notification::make('approval-success')
                            ->success()
                    ...
                    Tables\Actions\BulkAction::make('approveMultiple')
                        ...
                        ->action(function (\Illuminate\Database\Eloquent\Collection $records) {
                            ...
                            if ($count > 0) {
                                ...
                                Notification::make('bulk-approval-success')
                                    ->success()
                                ...
                                // Popup notification that stays longer
                                Notification::make('bulk-approval-warning')
                                    ->warning()
                                    ->title('No Recipes Approved')
