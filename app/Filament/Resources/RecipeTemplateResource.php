...
use App\Filament\Resources\RecipeTemplateResource\Pages;
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('submissions')
                    ...
                    ->url(fn (RecipeTemplate $record) => route('filament.admin.resources.user-recipes.index', ['template_id' => $record->id])),
            ])
            ->bulkActions([
