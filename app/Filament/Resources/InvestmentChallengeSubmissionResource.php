...
use App\Filament\Resources\InvestmentChallengeSubmissionResource\Pages;
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('approve')
                    ...
                    ->action(function (UserInvestmentChallenge $record) {
                        ...
                        Notification::make('admin-investsmart-approval-success')
                            ->success()
                    ...
                    Tables\Actions\BulkAction::make('approveMultiple')
                        ...
                        ->action(function (\Illuminate\Database\Eloquent\Collection $records) {
                            ...
                            if ($count > 0) {
                                ...
                                Notification::make('admin-investsmart-bulk-approval-success')
                                    ->success()
                                ...
                                // Popup notification that stays longer
                                Notification::make('admin-investsmart-bulk-approval-warning')
                                    ->warning()
                                    ->title('No Submissions Approved')
