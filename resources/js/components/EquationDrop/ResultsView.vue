<template>
  <div class="results-container">
    <h2 class="text-2xl font-bold mb-4">Equation Drop Results</h2>
    <p class="text-gray-600 mb-6">View your performance history in the Equation Drop game.</p>
  ...
  methods: {
    async fetchResults() {
      try {
        ...
        const response = await fetch('/subjects/specialized/stem/equation-drop/results', {
          headers: {
