<x-layouts.app>
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mx-auto max-w-3xl">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Discussion</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-400">Update your discussion in {{ $studyGroup->name }}</p>
            </div>

            <div class="rounded-lg bg-white p-6 shadow-md dark:bg-zinc-800">
                <form action="{{ route('study-groups.discussions.update', [$studyGroup, $discussion]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', $discussion->title) }}" required
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="content" name="content" rows="8" required
                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 dark:border-gray-600 dark:bg-zinc-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-emerald-500 dark:focus:ring-emerald-500"
                            placeholder="Share your thoughts, ask questions, or start a conversation...">{{ old('content', $discussion->content) }}</textarea>
                    ...
                    <div class="flex justify-end gap-4">
                        <a href="{{ route('study-groups.discussions.show', [$studyGroup, $discussion]) }}" class="rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-zinc-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-zinc-700 dark:focus:ring-gray-700">
                            Cancel
                        </a>
