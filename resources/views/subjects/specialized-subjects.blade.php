<x-layouts.app>
    <div class="flex h-full w-full flex-1 flex-col gap-6 text-gray-100 p-6 border border-emerald-500 rounded-lg">
        ...
        <div class="p-6 bg-linear-to-br from-neutral-800 to-neutral-900 rounded-xl border border-neutral-700 shadow-lg">
            <h2 class="text-xl font-semibold text-white mb-3">About Specialized Subjects</h2>
            <p class="text-neutral-300 mb-4">
                Specialized subjects focus on advanced, niche areas of study that require deep expertise. These disciplines represent cutting-edge fields and emerging technologies that are shaping the future.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-white">Artificial Intelligence</h3>
                        <p class="text-neutral-400">Explore machine learning, neural networks, and AI applications across industries.</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="p-2 bg-emerald-500/10 rounded-lg mt-1">
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-white">Data Science</h3>
                        <p class="text-neutral-400">Master data analysis, visualization, and predictive modeling techniques.</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="p-2 bg-emerald-500/10 rounded-lg mt-1">
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-white">Cybersecurity</h3>
                        <p class="text-neutral-400">Learn to protect systems, networks, and data from digital attacks.</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="p-2 bg-emerald-500/10 rounded-lg mt-1">
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-white">Advanced Mathematics</h3>
                        <p class="text-neutral-400">Delve into complex mathematical theories and their applications.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-2">
                <h2 class="text-xl font-semibold text-white">Available Specialized Courses</h2>
        ...
        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3" id="challenge-grid">
            ...
            @else
                <div class="col-span-full flex flex-col items-center justify-center p-10 bg-neutral-800/50 rounded-xl border border-neutral-700">
                    ...
                    <p class="text-neutral-400 text-center mb-6">We're currently developing new specialized subject courses. Check back soon!</p>
