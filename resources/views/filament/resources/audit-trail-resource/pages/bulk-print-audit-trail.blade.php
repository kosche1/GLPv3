<x-filament-panels::page>
    <div class="flex flex-col gap-y-8 print:p-8">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold">Audit Trail Records</h1>
        ...
        <div class="border rounded-xl overflow-hidden page-break-inside-avoid mb-8">
            ...
            <div class="border-t p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">Additional Data</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
                            @foreach(json_decode($record['additional_data'], true) ?? [] as $key => $value)
                            <tr>
