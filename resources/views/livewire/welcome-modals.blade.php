    ...
    >
        ...
        <div x-show="showWelcomeModal"
            ...
            <div class="absolute inset-0 bg-neutral-900/70 backdrop-blur-md"></div>
                    ...
                    <div>
                        <p class="text-neutral-300 mb-2">
                            @php
                                ...
                                $latestReward = \App\Models\UserDailyReward::where('user_id', $user->id)
                                ...
                                // Get reward tier
                                $rewardTier = \App\Models\DailyRewardTier::where('day_number', $currentStreakDay)->first();
