    ...
    <div class="p-6 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-3">
                <h2 class="text-2xl font-semibold text-white mb-4">Course Progress Overview</h2>
            ...
            <h2 class="text-2xl font-semibold text-white mb-4">Active Courses</h2>
            <div class="space-y-4">
                <!-- Course Card 1 -->
                <div class="rounded-xl border border-neutral-700 bg-neutral-800 p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-neutral-900/50 hover:border-neutral-600 hover:bg-neutral-800/90">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-white">Introduction to Computer Science</h3>
                        <span class="px-3 py-1 text-sm rounded-full bg-green-900/50 text-green-100">In Progress</span>
                    </div>
                    <div class="mb-4">
                        <div class="w-full bg-neutral-700 rounded-full h-2.5">
                            <div class="bg-blue-600 h-2.5 rounded-full" style="width: 65%"></div>
                        </div>
                        <p class="text-sm text-neutral-400 mt-2">65% Complete</p>
                    </div>
                ...
                <div class="rounded-xl border border-neutral-700 bg-neutral-800 p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-neutral-900/50 hover:border-neutral-600 hover:bg-neutral-800/90">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-white">Data Structures and Algorithms</h3>
                        <span class="px-3 py-1 text-sm rounded-full bg-yellow-900/50 text-yellow-100">Upcoming Quiz</span>
                    </div>
                    <div class="mb-4">
                        <div class="w-full bg-neutral-700 rounded-full h-2.5">
                            <div class="bg-blue-600 h-2.5 rounded-full" style="width: 45%"></div>
                        </div>
                        <p class="text-sm text-neutral-400 mt-2">45% Complete</p>
                    </div>
                    <div class="flex justify-between text-sm text-neutral-400">
            ...
            <div class="flex justify-between items-center mt-4">
                <button class="p-2 text-white hover:bg-neutral-700 rounded-full focus:outline-none transition-all duration-300">
        ...
        <div class="col-span-1">
            <h2 class="text-2xl font-semibold text-white mb-4">Upcoming Deadlines</h2>
            <div class="rounded-xl border border-neutral-700 bg-neutral-800 p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-neutral-900/50 hover:border-neutral-600 hover:bg-neutral-800/90">
                <div class="space-y-4">
                    <div class="flex items-start space-x-4">
                        <div class="min-w-[60px] text-center">
                            <span class="block text-lg font-semibold text-white">MAR</span>
                            <span class="block text-2xl font-bold text-white">15</span>
                        </div>
                        <div>
                            <h4 class="text-white font-medium">Project Milestone 2</h4>
                            <p class="text-sm text-neutral-400">Introduction to Computer Science</p>
                        </div>
                    </div>
                    <div class="flex items-start space-x-4">
                        <div class="min-w-[60px] text-center">
                        ...
                        <div>
                            <h4 class="text-white font-medium">Binary Trees Quiz</h4>
                            <p class="text-sm text-neutral-400">Data Structures and Algorithms</p>
                        </div>
                    </div>
                </div>
            </div>
