                ...
                <div class="flex flex-col sm:flex-row items-start justify-between gap-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-neutral-400">{{ auth()->user()->email }}</p>
                        </div>
                    </div>
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div class="bg-linear-to-br from-neutral-800 to-neutral-900 rounded-xl border border-neutral-700 p-6 overflow-hidden shadow-lg transition-all duration-300 ease-in-out hover:scale-[1.01] hover:border-emerald-500/30 hover:shadow-emerald-900/20">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="/settings/profile" class="w-full py-2 px-4 bg-emerald-500/10 text-emerald-400 rounded-lg border border-emerald-500/20 hover:bg-emerald-500/20 transition-colors duration-300 text-sm font-medium flex items-center justify-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                </svg>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-linear-to-br from-neutral-800 to-neutral-900 rounded-xl border border-neutral-700 p-6 overflow-hidden shadow-lg transition-all duration-300 ease-in-out hover:scale-[1.01] hover:border-emerald-500/30 hover:shadow-emerald-900/20">
                        ...
                        <div class="space-y-4">
                            <div class="p-4 rounded-lg bg-neutral-800/50 border border-neutral-700">
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm text-neutral-300">{{ __('PHP Basics') }}</span>
                            ...
                            <div class="p-4 rounded-lg bg-neutral-800/50 border border-neutral-700">
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm text-neutral-300">{{ __('Laravel Fundamentals') }}</span>
