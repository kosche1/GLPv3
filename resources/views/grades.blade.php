<x-layouts.app>
    <div class="flex h-full w-full flex-1 flex-col gap-6 text-gray-100 p-6 border border-emerald-500 rounded-lg">
            ...
            <div class="flex flex-col md:flex-row items-center gap-4">
                ...
                <div class="relative w-full md:w-auto">
                    ...
                    <input type="text" placeholder="Search courses..." 
                        class="w-full md:min-w-[250px] rounded-lg border border-neutral-700 bg-neutral-800 pl-10 pr-4 py-2 text-sm text-white placeholder-neutral-400 focus:border-emerald-500/30 focus:outline-none transition-all duration-300 hover:border-neutral-600">
                </div>

                <!-- Filter Dropdown -->
                <div x-data="{ semester: 'current' }">
                    <select class="w-full md:w-auto rounded-lg border border-neutral-700 bg-neutral-800 px-4 py-2 text-sm text-white focus:border-emerald-500/30 focus:outline-none transition-all duration-300 hover:border-neutral-600" 
                            x-model="semester" 
                            @change="$wire.setSemester(semester)">
                            <option value="all">All Semesters</option>
                            <option value="all">1st Semester</option>
                            <option value="all">2nd Semesters</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-6 md:grid-cols-3">
            <div class="flex flex-col justify-between p-6 rounded-xl border border-neutral-700 bg-gradient-to-br from-neutral-800 to-neutral-900 transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-900/20 hover:border-emerald-500/30">
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                    ...
                    <p class="text-3xl font-semibold text-white">3.85</p>
            ...
            <div class="flex flex-col justify-between p-6 rounded-xl border border-neutral-700 bg-gradient-to-br from-neutral-800 to-neutral-900 transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-900/20 hover:border-emerald-500/30">
                <div class="space-y-3">
                    ...
                    <p class="text-3xl font-semibold text-white">3.92</p>
            ...
            <div class="flex flex-col justify-between p-6 rounded-xl border border-neutral-700 bg-gradient-to-br from-neutral-800 to-neutral-900 transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-900/20 hover:border-emerald-500/30">
                <div class="space-y-3">
                    ...
                    <p class="text-3xl font-semibold text-white">86</p>
        ...
        <!-- Course Grades Table -->
        <div class="rounded-xl border border-neutral-700 bg-gradient-to-br from-neutral-800 to-neutral-900 transition-all duration-300 ease-in-out hover:border-emerald-500/30 hover:shadow-lg hover:shadow-emerald-900/20">
            <div class="border-b border-neutral-700 px-6 py-4 flex items-center justify-between">
                ...
                <span class="text-sm text-neutral-400">Spring 2025</span>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-neutral-700 text-sm">
                            ...
                            <th class="whitespace-nowrap px-6 py-4 text-left font-medium text-neutral-400">{{ __('Code') }}</th>
                    ...
                    <tbody class="divide-y divide-neutral-700">
                        <tr class="text-sm transition-colors hover:bg-neutral-700/50">
                            <td class="whitespace-nowrap px-6 py-4 text-white">Advanced Mathematics</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">MATH301</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">3</td>
                        ...
                        <tr class="text-sm transition-colors hover:bg-neutral-700/50">
                            <td class="whitespace-nowrap px-6 py-4 text-white">Computer Science Fundamentals</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">CS201</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">4</td>
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="text-emerald-400 font-medium">A-</span>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4">
                        ...
                        <tr class="text-sm transition-colors hover:bg-neutral-700/50">
                            <td class="whitespace-nowrap px-6 py-4 text-white">Data Structures</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">CS302</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">4</td>
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="text-blue-400 font-medium">B+</span>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4">
                        ...
                        <tr class="text-sm transition-colors hover:bg-neutral-700/50">
                            <td class="whitespace-nowrap px-6 py-4 text-white">Web Development</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">CS310</td>
                            <td class="whitespace-nowrap px-6 py-4 text-neutral-400">3</td>
                            <td class="whitespace-nowrap px-6 py-4">
                                <span class="text-emerald-400 font-medium">A</span>
                            </td>
        ...
        <!-- GPA Progress Bar -->
        <div class="rounded-xl border border-neutral-700 bg-gradient-to-br from-neutral-800 to-neutral-900 p-6 transition-all duration-300 ease-in-out hover:border-emerald-500/30 hover:shadow-lg hover:shadow-emerald-900/20">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">96% to Target</span>
            </div>
            <div class="p-4 rounded-lg bg-neutral-800/50 border border-neutral-700">
                <div class="w-full h-3 bg-neutral-700 rounded-full">
                    <div class="h-3 bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full" style="width: 96%"></div>
                </div>
                <div class="flex justify-between text-sm mt-2">
                    <span class="text-neutral-400">Target GPA: 4.0</span>
                    <span class="text-emerald-400">Current: 3.85</span>
                </div>
            </div>
        </div>
    </div>
