<div class="flex flex-row">
    <div class="w-full">
        <div class="flex rounded-lg shadow-md border border-gray-300 dark:border-neutral-700 bg-white dark:bg-gray-900 overflow-hidden transition-all hover:border-primary-300 dark:hover:border-primary-700">
            ...
            <form wire:submit.prevent="sendMessage" class="w-full dark:text-gray-200 flex-grow">
                <input
                    type="text"
                    wire:model.live="messageInput"
                    placeholder="Type your message here..."
                    class="py-3 px-4 block w-full text-sm focus:ring-0 focus:border-primary-500 border-0 dark:bg-gray-900 dark:placeholder-gray-500 focus-visible:outline-none"
                    autofocus
                    autocomplete="off">
            </form>
