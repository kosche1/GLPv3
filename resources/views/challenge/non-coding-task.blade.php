<x-layouts.app>
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div id="next-task-url" class="hidden" data-url="{{ $nextTask ? ($challenge->subject_type === 'core' ? route('core.challenge.task', ['challenge' => $challenge, 'task' => $nextTask]) : route('challenge.task', ['challenge' => $challenge, 'task' => $nextTask])) : '' }}"></div>
        ...
        <div class="relative bg-neutral-800 rounded-xl shadow-lg p-8 max-w-md w-full mx-4 border border-emerald-500/30 transform transition-all">
            ...
            <div class="text-center">
                ...
                <div class="flex flex-col gap-3">
                    @if($nextTask)
                        <a href="{{ $challenge->subject_type === 'core' ? route('core.challenge.task', ['challenge' => $challenge, 'task' => $nextTask]) : route('challenge.task', ['challenge' => $challenge, 'task' => $nextTask]) }}" class="w-full py-3 px-4 rounded-xl bg-emerald-500 hover:bg-emerald-600 transition-colors duration-300 text-white font-semibold text-center flex items-center justify-center gap-2">
                            <span>Next Task</span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
