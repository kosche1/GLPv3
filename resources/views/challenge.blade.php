    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="grid gap-6 md:grid-cols-3">
            ...
            <div class="flex flex-col p-6 rounded-xl border border-neutral-700 bg-linear-to-br from-neutral-800 to-neutral-900 shadow-lg">
                ...
                <div class="mb-4 p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                    <h3 class="text-lg font-semibold text-white mb-2 flex items-center gap-2">
                    ...
                    <p class="text-neutral-300">You need to reach level {{ $challenge->required_level }} to access the tasks in this challenge. Your current level is {{ $userLevel }}.</p>
                </div>
                @endif
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            @if($previousTaskCompleted)
                                                ...
                                                @elseif(isset($isLocked) && $isLocked)
                                                    <span class="px-6 py-1.5 text-sm font-medium rounded-lg bg-amber-500/20 text-amber-400 cursor-not-allowed flex items-center gap-1.5">
                                                        Level Required
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                                        </svg>
