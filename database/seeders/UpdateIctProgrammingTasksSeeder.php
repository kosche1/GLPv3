...
class UpdateIctProgrammingTasksSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if ($pythonChallenge) {
            ...
            Task::where('challenge_id', $pythonChallenge->id)->delete();
            
            // Create new Python tasks
            $this->createPythonTasks($pythonChallenge);
            $this->command->info('Python Programming tasks updated successfully!');
        } else {
        ...
        if ($jsChallenge) {
            // Delete existing tasks for this challenge
            Task::where('challenge_id', $jsChallenge->id)->delete();
            
            // Create new JavaScript tasks
        ...
        if ($javaChallenge) {
            // Delete existing tasks for this challenge
            Task::where('challenge_id', $javaChallenge->id)->delete();
            
            // Create new Java tasks
