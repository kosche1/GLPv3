...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('historical_timeline_maze_results')) {
            Schema::create('historical_timeline_maze_results', function (Blueprint $table) {
                $table->id();
                $table->foreignId('user_id')->constrained()->onDelete('cascade');
                $table->foreignId('historical_timeline_maze_id')->constrained('historical_timeline_mazes')->onDelete('cascade');
                $table->foreignId('era_id')->nullable()->constrained('historical_timeline_maze_events')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('historical_timeline_maze_results');
    }
};
